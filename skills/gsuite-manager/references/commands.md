...
Send a plain text email. Supports attachments.
...
```bash
gsuite send -t "user@example.com" -s "Hello" -b "Message content"
gsuite send -t "user@example.com" -s "Report" -b "See attached." --attach report.pdf --attach data.csv
